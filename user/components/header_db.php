...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/db-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 07:00:23 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
...
<body data-barba="wrapper">
  ...
  <div class="preloader js-preloader">
    ...
    <div class="preloader__title">Travel Voyage</div>
  </div>
    ...
    <div data-anim="fade" class="header__container px-30 sm:px-20">
      <div class="-left-side">
        <a href="index.html" class="header-logo" data-x="header-logo" data-x-toggle="is-logo-dark">
          <img src="img/logo/logo-removebg-preview.png" alt="logo icon">
        </a>
      </div>
      ...
      <div class="row justify-between items-center pl-60 lg:pl-20">
        ...
        <div class="col-auto">
          <div class="d-flex items-center">
            ...
            <div class="pl-15">
  <img src="https://via.placeholder.com/50x50/cccccc/000000?text=USER" alt="image" class="size-50 rounded-22 object-cover">
</div>
      ...
      <div class="sidebar -dashboard">
        ...
        <div class="sidebar__item">
          <div class="sidebar__button -is-active">
            <a href="index.php" class="d-flex items-center text-15 lh-1 fw-500">
              <img src="img/svg/dashboard-svgrepo-com.svg" alt="image" class="mr-15">
              Dashboard
            </a>
          </div>
        </div>
        ...
        <div class="sidebar__item">
          <div class="sidebar__button ">
            <a href="viewCategory.php" class="d-flex items-center text-15 lh-1 fw-500">
              <img src="img/svg/cat.svg" alt="image" class="mr-15">
              Category
            </a>
          </div>
        </div>
        ...
        <div class="sidebar__item">
          <div class="sidebar__button ">
            <a href="viewTrip.php" class="d-flex items-center text-15 lh-1 fw-500">
              <img src="img/svg/road-alt-svgrepo-com.svg" alt="image" class="mr-15">
              Trips
            </a>
          </div>
        </div>
        ...
        <div class="sidebar__item">
          <div class="sidebar__button ">
            <a href="viewExpenses.php" class="d-flex items-center text-15 lh-1 fw-500">
              <img src="img/svg/money-svgrepo-com.svg" alt="image" class="mr-15">
              Expanses
            </a>
          </div>
        </div>
        ...
        <div class="sidebar__item">
          <div class="sidebar__button ">
            <a href="reporting.php" class="d-flex items-center text-15 lh-1 fw-500">
              <img src="img/svg/reports-svgrepo-com.svg" alt="image" class="mr-15">
              Reports
            </a>
          </div>
        </div>
        ...
        <div class="sidebar__item">
          <div class="sidebar__button ">
            <a href="db-settings.php" class="d-flex items-center text-15 lh-1 fw-500">
              <img src="img/svg/setting-svgrepo-com.svg" alt="image" class="mr-15">
              Settings
            </a>
          </div>
        </div>
        ...
        <div class="sidebar__item">
          <div class="sidebar__button ">
            <a href="../admin/logout.php" class="d-flex items-center text-15 lh-1 fw-500">
              <img src="img/svg/logout-svgrepo-com.svg" alt="image" class="mr-15">
              Logout
            </a>
          </div>
        </div>
