...
<!-- Mirrored from creativelayers.net/themes/gotrip-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Sep 2024 06:58:25 GMT -->
...
<body>
  ...
  <main>
    ...
    <header data-add-bg="" class="header bg-green js-header bg-dark-1" data-x="header" data-x-toggle="is-menu-opened">
      <div data-anim="fade" class="header__container px-30 sm:px-20">
        <div class="row justify-between items-center">

          <div class="col-auto">
            <div class="d-flex items-center">
              <a href="index.php" class="a.header-logo.mr-20 mb-2 main-logo" id="img" data-x="header-logo" data-x-toggle="is-logo-dark">
                ...
                <div class="header-menu__content">
                  ...
                  <div class="menu js-navList">
                    <ul class="menu__nav text-white -is-active">
                      ...
                      <li>
                        <a href="destination.php">Gallery</a>
                      </li>
