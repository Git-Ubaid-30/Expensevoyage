<!DOCTYPE html><html lang="en" data-x="html" data-x-toggle="html-overflow-hidden"><head>
  <!-- Required meta tags -->
  <meta charset="UTF-8">
          ...
          <div class="col-auto">
            <div class="d-flex items-center">
              <a href="#" class="header-logo mr-20" data-x="header-logo" data-x-toggle="is-logo-dark">
                <img src="img/logo-dark.svg" alt="logo icon">
                <img src="img/logo-dark.svg" alt="logo icon">
              </a>
                            ...
                            <div class="tabs__content js-tabs-content">
                              ...
                              <div class="tabs__pane -tab-item-2">
                                <div class="mega__content">
                                  ...
                                  <div class="mega__image d-flex relative">
                                    <img src="img/7.png" alt="image" class="rounded-4">
          ...
          <div class="col-auto">
            <div class="d-flex items-center">
              ...
              <div class="row x-gap-20 items-center xxl:d-none">
                ...
                <div class="col-auto">
                  <button class="d-flex items-center text-14 text-dark-1" data-x-click="lang">
                    <img src="img/lang.png" alt="image" class="rounded-full mr-10">
              ...
              <div class="d-flex items-center ml-20 is-menu-opened-hide md:d-none">
                ...
                <a href="register.php" class="button px-30 fw-400 text-14 -outline-blue-1 h-50 text-blue-1 ml-20">Sign In / Register</a>
              </div>
