      ...
      <div class="row justify-between items-center pl-60 lg:pl-20">
        ...
        <div class="col-auto">
          <div class="d-flex items-center">
            ...
            <div class="pl-15">
  <img src="https://via.placeholder.com/50x50/cccccc/000000?text=ADMIN" alt="image" class="size-50 rounded-22 object-cover">
</div>
      ...
      <div class="sidebar -dashboard">
        ...
        <div class="sidebar__item">
          <div class="sidebar__button -is-active">
            <a href="admin/db-dash.php" class="d-flex items-center text-15 lh-1 fw-500">
        ...
        <div class="sidebar__item">
          <div class="sidebar__button ">
            <a href="view_destination.php" class="d-flex items-center text-15 lh-1 fw-500">
              <img src="img/svg/destination-ensign-flag-svgrepo-com.svg" alt="image" class="mr-15">
              Destination
            </a>
          </div>
        </div>
        ...
        <div class="sidebar__item">
          <div class="sidebar__button ">
            <a href="viewgallery.php" class="d-flex items-center text-15 lh-1 fw-500">
              <img src="img/svg/gallery-round-svgrepo-com.svg" alt="image" class="mr-15">
              Gallery
            </a>
          </div>
        </div>
